...
default['echo']['path'] = "#{ENV['HOMEPATH']}/Desktop/Radio/"

#Destination path where files will be downloaded and saved
#Default value is: 'E:/LIBRARY/Audio/Radio_Echo/'
default['echo']['arcPath'] = 'E:/LIBRARY/Audio/Radio_Echo/'
